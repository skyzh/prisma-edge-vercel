...
// node_modules/.pnpm/@neondatabase+serverless@0.5.6/node_modules/@neondatabase/serverless/index.js
var require_serverless = __commonJS({
  "node_modules/.pnpm/@neondatabase+serverless@0.5.6/node_modules/@neondatabase/serverless/index.js"(exports, module2) {
    "use strict";
    ...
    var ro = (r, e, t) => e in r ? _e(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
    var a = (r, e) => _e(r, "name", { value: e, configurable: true });
    var W = (r, e) => () => (r && (e = r(r = 0)), e);
    var I = (r, e) => () => (e || r((e = { exports: {} }).exports, e), e.exports);
    var Y = (r, e) => {
      for (var t in e)
        _e(r, t, { get: e[t], enumerable: true });
    };
    var An = (r, e, t, n) => {
      if (e && typeof e == "object" || typeof e == "function")
        for (let i of Xs(e))
          !to.call(r, i) && i !== t && _e(r, i, { get: () => e[i], enumerable: !(n = Js(e, i)) || n.enumerable });
      return r;
    };
    ...
    var U = (r) => An(_e({}, "__esModule", { value: true }), r);
    ...
    var Tn = I((nt) => {
      ...
      function oo(r) {
        ...
        for (c = 0; c < u; c += 4)
          e = J[r.charCodeAt(c)] << 18 | J[r.charCodeAt(c + 1)] << 12 | J[r.charCodeAt(
            c + 2
          )] << 6 | J[r.charCodeAt(c + 3)], s[o++] = e >> 16 & 255, s[o++] = e >> 8 & 255, s[o++] = e & 255;
      ...
      function uo(r, e, t) {
        for (var n, i = [], s = e; s < t; s += 3)
          n = (r[s] << 16 & 16711680) + (r[s + 1] << 8 & 65280) + (r[s + 2] & 255), i.push(ao(n));
        return i.join("");
      }
      a(uo, "encodeChunk");
      function co(r) {
        for (var e, t = r.length, n = t % 3, i = [], s = 16383, o = 0, u = t - n; o < u; o += s)
          i.push(uo(r, o, o + s > u ? u : o + s));
    ...
    var Pn = I((Pt) => {
      ...
      Pt.write = function(r, e, t, n, i, s) {
        ...
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (u = isNaN(e) ? 1 : 0, o = f) : (o = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -o)) < 1 && (o--, c *= 2), o + m >= 1 ? e += x / c : e += x * Math.pow(2, 1 - m), e * c >= 2 && (o++, c /= 2), o + m >= f ? (u = 0, o = f) : o + m >= 1 ? (u = (e * c - 1) * Math.pow(
          2,
          i
        ), o = o + m) : (u = e * Math.pow(2, m - 1) * Math.pow(2, i), o = 0)); i >= 8; r[t + _] = u & 255, _ += P, u /= 256, i -= 8)
          ;
    ...
    var $n = I((Te) => {
      ...
      l.concat = a(function(e, t) {
        ...
        for (n = 0; n < e.length; ++n) {
          let o = e[n];
          if (ae(o, Uint8Array))
            s + o.length > i.length ? (l.isBuffer(
              o
            ) || (o = l.from(o)), o.copy(i, s)) : Uint8Array.prototype.set.call(i, o, s);
          else if (l.isBuffer(
            o
          ))
            o.copy(i, s);
      ...
      function Hn(r, e, t, n, i, s) {
        if (r > t || r < e) {
          ...
          throw s > 3 ? e === 0 || e === BigInt(0) ? u = `>= 0${o} and < 2${o} ** ${(s + 1) * 8}${o}` : u = `>= -(2${o} ** ${(s + 1) * 8 - 1}${o}) and < 2 ** ${(s + 1) * 8 - 1}${o}` : u = `>= ${e}${o} and <= ${t}${o}`, new Ae.ERR_OUT_OF_RANGE(
            "value",
            u,
            r
          );
    ...
    var ye = I((Jc, Nt) => {
      ...
      R.prototype.emit = a(function(e) {
        ...
        if (typeof c == "function")
          ...
          for (var h = c.length, f = ri(c, h), n = 0; n < h; ++n)
            Vn(f[n], this, t);
        return true;
      }, "emit");
      function Jn(r, e, t, n) {
        var i, s, o;
        if (at(t), s = r._events, s === void 0 ? (s = r._events = /* @__PURE__ */ Object.create(null), r._eventsCount = 0) : (s.newListener !== void 0 && (r.emit("newListener", e, t.listener ? t.listener : t), s = r._events), o = s[e]), o === void 0)
      ...
      R.prototype.removeListener = a(function(e, t) {
        ...
        if (n === t || n.listener === t)
          ...
          if (s < 0)
            return this;
          s === 0 ? n.shift() : Oo(n, s), n.length === 1 && (i[e] = n[0]), i.removeListener !== void 0 && this.emit(
            "removeListener",
            e,
            u || t
          );
      ...
      function No(r, e) {
        return new Promise(
          function(t, n) {
            ...
            a(s, "resolver"), ni(r, e, s, { once: true }), e !== "error" && Qo(r, i, { once: true });
          }
        );
      }
      a(No, "once");
          ...
          return this.ws = await new Promise(async (o) => {
            try {
              ...
              try {
                ...
                await fetch(h, { headers: { Upgrade: "websocket" } }).then((f) => {
                  let m = f.webSocket;
                  if (m == null)
                    throw u;
                  m.accept(), o(m);
    ...
    function We(r) {
      ...
      return r === void 0 ? { add: z, digest: ue } : (z(
        r
      ), ue());
    }
    var oi = W(() => {
    ...
    var fi = I((wh, li) => {
      ...
      li.exports = a(function(e) {
        ...
        var s = parseInt(
          t[2],
          10
        ) - 1, o = t[3], u = parseInt(t[4], 10), c = parseInt(t[5], 10), h = parseInt(t[6], 10), f = t[7];
        f = f ? 1e3 * parseFloat(f) : 0;
        var m, x = Xo(e);
        return x != null ? (m = new Date(Date.UTC(
          i,
          s,
          o,
          u,
          ...
          h,
          f
        )), $t(i) && m.setUTCFullYear(i), x !== 0 && m.setTime(m.getTime() - x)) : (m = new Date(
          i,
          s,
          o,
          u,
    ...
    var Ti = I((Fh, Ii) => {
      ...
      function va(r) {
        ...
        var i = "", s, o, u, c, h, f;
        {
          if (s = e % $, e = e / $ >>> 0, o = 4294967296 * s + t, t = o / $ >>> 0, u = "" + (o - $ * t), t === 0 && e === 0)
            return n + u + i;
          for (c = "", h = 6 - u.length, f = 0; f < h; f++)
            c += "0";
          i = c + u + i;
        }
        {
    ...
    var Fi = I((kh, Ri) => {
      ...
      var _a = Ti(), F = a(function(r, e, t, n, i) {
        ...
        var u = a(function(h) {
          ...
          var m;
          if (h == 23 || h == 20)
            return m = F(r, f * 8, i), i += f * 8, m;
          if (h == 25)
            return m = r.toString(this.encoding, i >> 3, (i += f << 3) >> 3), m;
    ...
    var Hi = I((rl, ji) => {
      ...
      function Ya(r, e, t) {
        ...
        var i = d.from(n.salt, "base64"), s = ru(
          e,
          i,
          n.iteration
        ), o = Re(s, "Client Key"), u = tu(o), c = "n=*,r=" + r.clientNonce, h = "r=" + n.nonce + ",s=" + n.salt + ",i=" + n.iteration, f = "c=biws,r=" + n.nonce, m = c + "," + h + "," + f, x = Re(u, m), _ = Wi(
          o,
          x
        ), P = _.toString("base64"), k = Re(s, "Server Key"), z = Re(k, m);
    ...
    var Yi = I((fl, zi) => {
      ...
      function hu(r, e, t) {
        ...
        let n = new ou(t);
        return n[ge] = "", n[dt] = new au("utf8"), n.matcher = r, n.mapper = e, n.maxLength = t.maxLength, n.skipOverflow = t.skipOverflow || false, n.overflow = false, n._destroy = function(i, s) {
...
`);
      ...
      var xu = fe.exports.parseLine = function(r) {
        if (r.length < 11 || r.match(/^\s+#/))
          return null;
        for (var e = "", t = "", n = 0, i = 0, s = 0, o = {}, u = false, c = a(function(f, m, x) {
          var _ = r.substring(
            m,
            x
          );
    ...
    var wt = I((Tl, cs) => {
      "use strict";
      p();
      var Cu = (is(), U(ns)), us = Ye(), as = os().parse, j = a(
        function(r, e, t) {
      ...
      var dc = ye().EventEmitter, uf = (et(), U(Xe)), yc = Ze(), fn = Hi(), mc = ts(), gc = dr(), wc = wt(), Ls = ms(), bc = Ye(), Sc = ln(), pn = class pn extends dc {
        ...
        query(e, t, n) {
          ...
          return typeof e.submit == "function" ? (o = e.query_timeout || this.connectionParameters.query_timeout, s = i = e, typeof t == "function" && (i.callback = i.callback || t)) : (o = this.connectionParameters.query_timeout, i = new Ls(
            ...
            t,
            n
          ), i.callback || (s = new this._Promise((h, f) => {
    ...
    function pt(r, { arrayMode: e, fullResults: t, fetchOptions: n, queryCallback: i, resultCallback: s } = {}) {
      ...
      if (u !== "postgres:" && u !== "postgresql:" || !c || !h || !f || !x)
      ...
      return async function(_, ...P) {
        let k = e ?? false, z = t ?? false, ue = n ?? {}, B;
        if (typeof _ == "string") {
          B = _;
          let C = P[1];
          C !== void 0 && (C.arrayMode !== void 0 && (k = C.arrayMode), C.fullResults !== void 0 && (z = C.fullResults), C.fetchOptions !== void 0 && (ue = { ...ue, ...C.fetchOptions })), P = P[0] ?? [];
        } else {
          B = "";
        ...
        let {
          ...
          fetchFunction: be
        } = me, Z = typeof v == "function" ? v(f, m) : v, pe = te === true ? { "Neon-Pool-Opt-In": "true" } : {}, re = { query: B, params: P };
        i && i(re);
        ...
        if (L.ok) {
          let C = await L.json(), H = C.fields.map((ne) => ne.name), ce = C.fields.map((ne) => K.types.getTypeParser(ne.dataTypeID)), se = k === true ? C.rows.map((ne) => ne.map((he, ve) => he === null ? null : ce[ve](he))) : C.rows.map((ne) => Object.fromEntries(ne.map((he, ve) => [H[ve], he === null ? null : ce[ve](he)])));
          return s && s(re, C, se, { arrayMode: k, fullResults: z }), z ? (C.viaNeonFetch = true, C.rowAsArray = k, C.rows = se, C) : se;
        } else {
          let { status: C } = L;
          if (C === 400) {
    ...
    var vn = class vn extends It.Client {
      ...
      async _handleAuthSASLContinue(t) {
        ...
        if (u.length === n.clientNonce.length)
          throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: server nonce is too short");
        let f = parseInt(h, 10), m = d.from(c, "base64"), x = new TextEncoder(), _ = x.encode(i), P = await g.subtle.importKey("raw", _, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]), k = new Uint8Array(await g.subtle.sign("HMAC", P, d.concat([m, d.from(
          [0, 0, 0, 1]
        )]))), z = k;
        for (var ue = 0; ue < f - 1; ue++)
          k = new Uint8Array(await g.subtle.sign(
            "HMAC",
            P,
            k
          )), z = d.from(z.map((qe, Se) => z[Se] ^ k[Se]));
        let B = z, v = await g.subtle.importKey(
          "raw",
          B,
          ...
          "SHA-256",
          te
        ), Z = "n=*,r=" + n.clientNonce, pe = "r=" + u + ",s=" + c + ",i=" + f, re = "c=biws,r=" + u, ie = Z + "," + pe + "," + re, L = await g.subtle.importKey(
          "raw",
          be,
          { name: "HMAC", hash: { name: "SHA-256" } },
          false,
        ...
        let se = await g.subtle.importKey("raw", B, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]), ne = await g.subtle.sign("HMAC", se, x.encode("Server Key")), he = await g.subtle.importKey("raw", ne, { name: "HMAC", hash: { name: "SHA-256" } }, false, ["sign"]);
    ...
    var _n = class _n extends It.Pool {
      ...
      query(t, n, i) {
        ...
        try {
          ...
          pt(h, { fullResults: true, arrayMode: t.rowMode === "array" })(f, m).then((_) => i(void 0, _)).catch((_) => i(_));
        } catch (o) {
          i(o);
        }
        return s.result;
...
// node_modules/.pnpm/@neondatabase+serverless@0.5.6/node_modules/@neondatabase/serverless/index.mjs
...
var PrismaNeon = class {
   ...
   */
  isHealthy() {
    const result = this.maybeVersion !== void 0 && this.isRunning;
    return result;
  }
  /**
...
var createNeonConnector = (config) => {
...
async function init(input) {
  if (typeof input === "undefined") {
    input = new URL("query_engine_bg.wasm", import_meta.url);
  }
...
async function query(q) {
  ...
  console.log(q);
  const resultSet = await engine.query(q, "trace", void 0);
